...
export default function EmailComposer({email, content, subject}: EmailComposerProps) {
    ...
    return (
        <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
            <input className="w-full h-64 p-2 mb-4 border border-gray-300 rounded-md resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                   value={emailSubject} id="subject"
