...
export function SharedChatMessage({message, user, ...props}: ChatMessageProps) {
    return (
        <div
        ...
        >
            ...
            >
                {message.role === 'user' ?  <Image src="/logo.png" width={32} height={32} alt="PreloVC Logo" className="rounded-full" />:
                    <ChatUser user={user}/>}
            </div>
